...
Снимок: **4 сентября 2026**. Продукт **0.4.0** — [versions.md](./versions.md). Дорожка D закрыта. **E без ИИ**: генератор, история склеек, разрез/правка, склейка, квоты формы, разрез диапазоном, своя очередь карусели и история снимков — заархивировано. Энергию 1–5 не берём. Что ещё не делали — [roadmap E](./roadmap.md). `bun run typecheck` зелёный на клиенте и сервере.
