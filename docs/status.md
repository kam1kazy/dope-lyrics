...
| Сервер | `bun run import:apple-notes`; бот `/notes` (скрипт + zip) |
...
Ближайшее без ИИ — шлифовка; выгрузка корпуса Notes на прод через `/notes`. ИИ и шов — не сейчас. Mini App: [0007](./decisions/0007-mini-app-initdata.md).
