...
## D. Инструмент — закрыта

Порядок, теги, ключевые слова, эмодзи, период, полка эталонов — в GraphQL и drawer. [`tasks/003_catalog_controls.md`](./tasks/003_catalog_controls.md).

## E. Сигналы и ИИ — сейчас
